    ...
    private void SetIcon(){
        ...
        switch (itemType){
            case ItemType.Sticker:
                ...
                img_bg.color = new Color32(255, 174, 0, 144); // 橘色
                break;
            case ItemType.StickerChip:
                ...
                break;
            case ItemType.HappyGrass:
                img_icon.sprite = factory.LoadHappyGrassIcon();
                img_bg.color = new Color32(255, 174, 0, 144); // 橘色
                break;
            default:
    ...
    public void AddItem(){
        ...
        switch (itemType){
            ...
            case ItemType.StickerChip:
                ...
                break;
            case ItemType.HappyGrass:
                GameMediator.Instance.AddHappyGrass(_loot._dropCount);
                break;
            default:
                Debug.Log($"找不到item類型{itemType}");
                break;
